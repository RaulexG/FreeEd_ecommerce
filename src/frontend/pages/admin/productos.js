  ...
  const content = `
    <section class="space-y-6">
      <header class="flex items-center justify-between">
        ...
        <a
          href="/admin"
          class="text-xs sm:text-sm text-indigo-600 hover:text-indigo-700 hover:underline"
        >
          ← Volver al panel
        </a>
      </header>
    ...
    <script>
      (function () {
        ...
        document.addEventListener("DOMContentLoaded", () => {
          ...
          // Delegación para tabla (click en fila = editar, click en botón = eliminar)
